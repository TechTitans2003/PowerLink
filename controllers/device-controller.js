...
const addDevice = async (req, res, next) => {
    try {
        ...
        const { deviceName, poleId } = req.body;
        ...
        // Create the new device with default values for current, voltage, resistance, earthResistance
        const device = await Device.create({
            name: deviceName,
            current: "0",  // Default value
            voltage: "0",  // Default value
            resistance: "0",  // Default value
            earthResistance: "0",  // Default value
            latitude: "Lat",
            longitude: "Long",
            poleId,
            user: userId,
...
const getDeviceInfo = async (req, res, next) => {
    ...
    try {
        ...
        return res.status(200)
        .render("device-info", {device, user});
            // .json({
